 ...
 */
public class BooleanStringDataTypeConvertor  extends AbstractDataTypeConvertor{
    @Override
    protected void doConvert(Cell cell, ColStyle colStyle, Object o) {
        String value = DataTypeUtils.getBooleanStringValue(o, colStyle.getDefaultValue());
